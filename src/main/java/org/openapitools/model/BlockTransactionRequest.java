...
@Schema(name = "BlockTransactionRequest", description = "A BlockTransactionRequest is used to fetch a Transaction included in a block that is not returned in a BlockResponse.")
