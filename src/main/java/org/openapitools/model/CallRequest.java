...
@Schema(name = "CallRequest", description = "CallRequest is the input to the `/call` endpoint.")
...
public class CallRequest {
  ...
  */
  @NotNull 
  @Schema(name = "method", example = "eth_call", description = "Method is some network-specific procedure call. This method could map to a network-specific RPC endpoint, a method in an SDK generated from a smart contract, or some hybrid of the two. The implementation must define all available methods in the Allow object. However, it is up to the caller to determine which parameters to provide when invoking `/call`.", requiredMode = Schema.RequiredMode.REQUIRED)
  ...
  */
  @NotNull 
  @Schema(name = "parameters", example = "{\"block_number\":23,\"address\":\"0x52bc44d5378309ee2abf1539bf71de1b7d7be3b5\"}", description = "Parameters is some network-specific argument for a method. It is up to the caller to determine which parameters to provide when invoking `/call`.", requiredMode = Schema.RequiredMode.REQUIRED)
