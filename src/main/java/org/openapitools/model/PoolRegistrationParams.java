...
import org.openapitools.model.PoolMargin;
import org.openapitools.model.PoolMetadata;
import org.openapitools.model.Relay;
...
public class PoolRegistrationParams {
  ...
  */
  ...
  public PoolRegistrationParams relays(List<Relay> relays) {
    this.relays = relays;
    return this;
  }

  public PoolRegistrationParams addRelaysItem(Relay relaysItem) {
